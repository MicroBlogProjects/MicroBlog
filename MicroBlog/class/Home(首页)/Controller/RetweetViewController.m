...
@interface RetweetViewController ()<UITextViewDelegate,ComposeToolbarDelegate,UINavigationControllerDelegate,UIImagePickerControllerDelegate>
/** 输入控件  */
...
-(void)sendComment {
    ...
    params[@"status"] = self.textView.fullText?self.textView.fullText:@"";
    params[@"id"] = self.idstr ;
    [manager POST:@"https://api.weibo.com/2/statuses/repost.json" parameters:params success:^(AFHTTPRequestOperation *operation, NSDictionary * responseObject){
