...
- (void)viewDidLoad {
    ...
    */
    NSURL *url = [NSURL URLWithString:@"https://api.weibo.com/oauth2/authorize?client_id=2915497033&redirect_uri=http://"];
...
/*进行POST操作*/
    ...
    params[@"client_id"]     = @"2915497033" ;
    params[@"client_secret"] = @"84c8eda8fb9be1b8429cd9287a6fc398";
